...
類似星海爭霸的即時戰略防禦遊戲。玩家在地圖上建造基地、訓練兵種、抵禦 10 波哥布林進攻。

**技術棧:** Phaser 3.60 (CDN) + JavaScript ES Modules + live-server

**地圖:** 2560×1536 像素 (40×24 格, 每格 64px)
**視窗:** 1280×768 像素
